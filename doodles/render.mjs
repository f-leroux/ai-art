...
//   node render.mjs full [fps] [crf]  -> ./out/doodles.mp4
...
const mime = { '.html': 'text/html', '.js': 'text/javascript', '.mp3': 'audio/mpeg', '.wav': 'audio/wav', '.json': 'application/json', '.jpg': 'image/jpeg', '.woff2': 'font/woff2' };
