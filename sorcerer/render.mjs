...
//   node render.mjs full [fps] [crf]  -> ./out/sorcerer.mp4
...
await page.goto('http://localhost:4182/index.html?render=1', { waitUntil: 'load' });
...
if (mode === 'contact') {
  ...
  const mp4 = path.join(out, 'sorcerer.mp4');
